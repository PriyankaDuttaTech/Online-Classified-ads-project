		...
		<div class="container">
			...
			<div class="headerright">
				<ul>
                    ...
                    <li><a href="http://localhost:90/project/tryprtoject/" class="signBtn">Home</a></li>
	 ...
	 <div class="productContent">
		<div class="container">
			<div class="productCategories">
				<ul>
					<li><a href="http://localhost:90/project/auto.py">Automobiles <i class="fas fa-caret-right"></i></a>
...
cursor.execute('SELECT u.*,p.* FROM userdata u INNER JOIN post_table p on u.User_id=p.User_id AND cat_id=2')
