...
if result:
    ...
    for rec in result:
        print '''<tr>
                ...
                <td>{}</td>
                <td>{}</td>
                <td><a href = "update.py?id={}"><img src = "images/b_edit.png"></a></td>
                <td><a href = "delete.py?id={}"><img src = "images/b_drop.png"></a></td>
            </tr>'''.format(rec[1], rec[2], rec[3],rec[4], rec[0], rec[0])
